...
export const metadata: Metadata = {
  title: "Grandview Hotel - Luxury Accommodations in the City",
  description: "Experience unparalleled luxury at Grandview Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, premium accommodations, fine dining, spa, city hotel, business travel, luxury suites",
  ...
  openGraph: {
    title: "Grandview Hotel - Luxury Accommodations in the City",
    description: "Experience unparalleled luxury at Grandview Hotel with premium rooms, world-class amenities, and exceptional service.",
    ...
    images: [{
      ...
      alt: "Grandview Hotel elegant exterior"
    }]
  },
  twitter: {
